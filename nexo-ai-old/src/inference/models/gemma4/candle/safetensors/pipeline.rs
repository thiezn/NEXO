...
use crate::inference::models::gemma4::config::{Gemma4Config, Gemma4TextConfig, Gemma4VisionConfig};
...
use crate::inference::candle::weights::find_safetensor_files;

use crate::inference::models::gemma4::generation::{self, TextForward};
...
pub fn load(model_dir: &Path, max_context_tokens: Option<usize>) -> Result<LoadedState> {
    ...
    let dtype = crate::inference::candle::device::gpu_compute_dtype(&device);
