...
use crate::inference::models::gemma4::common::template::Gemma4Template;
use crate::inference::models::support::prompting::ChatTemplate;
use crate::inference::remote::openai::model::{OpenAiFamilyAdapter, parse_wire_tool_calls};
use crate::inference::remote::openai::protocol::OpenAiResponseMessage;
