...
pub static GEMMA_4_E4B_IT_UQFF_AFQ6: LazyLock<ModelManifest> = LazyLock::new(|| {
...
/// Gemma 4 E4B-it model with UQFF.
pub static GEMMA_4_E4B_IT_UQFF_AFQ8: LazyLock<ModelManifest> = LazyLock::new(|| {
    ModelManifest::new_with_folder(
...
pub static GEMMA_4_26B_A4B_IT_UQFF_AFQ6: LazyLock<ModelManifest> = LazyLock::new(|| {
    ModelManifest::new_with_folder(
...
/// Gemma 4 26B A4B-it model with UQFF.
pub static GEMMA_4_26B_A4B_IT_UQFF_AFQ8: LazyLock<ModelManifest> = LazyLock::new(|| {
    ModelManifest::new_with_folder(
