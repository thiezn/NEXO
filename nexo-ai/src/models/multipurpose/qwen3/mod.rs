...
impl ModelInfo for Qwen3Model {
    ...
    fn categories(&self) -> &[ModelCategory] {
        if self
            .loaded
            .as_ref()
            .is_some_and(|s| s.vision.is_some())
        {
            &[ModelCategory::Chat, ModelCategory::Tool, ModelCategory::Image]
        } else {
            &[ModelCategory::Chat, ModelCategory::Tool]
        }
    }
...
impl ImageModel for Qwen3Model {
