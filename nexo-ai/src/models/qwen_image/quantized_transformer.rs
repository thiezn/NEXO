...
/// 3D RoPE embedder with centered positions for Qwen-Image.
///
/// Computes separate frequency tables for temporal/height/width axes.
/// Height and width use centered (negative+positive) positions,
/// temporal uses positive-only positions.
#[derive(Debug, Clone)]
...
/// Quantized Qwen-Image Transformer 2D Model (GGUF variant).
