...
impl Model {
    ...
    pub fn save_kv_cache(&self) -> candle_core::Result<Vec<text::LayerKvSnapshot>> {
        self.language_model.save_kv_cache()
    }

    pub fn restore_kv_cache(&mut self, snapshots: &[text::LayerKvSnapshot]) -> candle_core::Result<()> {
