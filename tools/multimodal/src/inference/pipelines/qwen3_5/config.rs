...
pub struct TextConfig {
    ...
    pub hidden_size: usize,
    // None for MoE models (35B), which use moe_intermediate_size instead
    ...
    // Linear (DeltaNet) attention params
...
impl TextConfig {
    ...
    pub fn is_linear_attention_layer(&self, layer_idx: usize) -> bool {
        if !self.layer_types.is_empty() {
            ...
            // Fallback: every full_attention_interval-th layer is full attention, rest linear
